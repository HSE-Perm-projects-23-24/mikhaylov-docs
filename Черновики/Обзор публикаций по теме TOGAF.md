...
В работе рассматривавется использование ADM метода стандарта TOGAF для разработки и внедрения архитектурных решений в сфере сетевого ритейла товаров повседневного спроса.
